package com.capnews.auth.backend.resources.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.mvcMatcher("/**")
                .authorizeRequests()
                .mvcMatchers(HttpMethod.POST, "/articles").hasAuthority("SCOPE_message.read")
                .mvcMatchers("/**").permitAll() // Allow GET requests to any other endpoint without requiring
                .and()
